...
- T4-9 and T5–T10 remain TODO for implementation/acceptance. Execute them continuously under one assignment; internal checkpoints do not require another user prompt. T3 packet-script coverage and IPv6 PTB injection still require explicit coverage accounting.
