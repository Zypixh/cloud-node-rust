...
pub struct Repr {
    ...
    /// smoltcp-edge (T3): ECN codepoint (0..=3), the low bits of the
    /// traffic-class byte — plumbed verbatim, no negotiation.
    pub ecn: u8,
...
impl Repr {
    ...
    pub fn emit<T: AsRef<[u8]> + AsMut<[u8]>>(&self, packet: &mut Packet<T>) {
        ...
        packet.set_traffic_class(self.ecn);
