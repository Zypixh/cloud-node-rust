...
日期：2026-09-15（UTC 系日志时间）· 主机：162.251.92.120（2c/1GB 级，kernel-BPF 预算约 134–137MB）
二进制：`cloud-node-rust` debug build，sha256 `e3314be7…`（.110 构建，经内网 `10.0.160.13→10.0.160.23` 直传校验一致）。
