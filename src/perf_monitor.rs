...
struct PerfSample {
    ...
    cache_bloom_count: u64,
    cache_bloom_capacity: u64,
    cache_bloom_estimated_bytes: u64,
...
async fn sample_loop(store: SharedStore) {
    ...
    loop {
        ...
        let sample = PerfSample {
            ...
            cache_bloom_count: cache_stats.bloom_count,
            cache_bloom_capacity: cache_stats.bloom_capacity,
            cache_bloom_estimated_bytes: cache_stats.bloom_estimated_bytes,
