...
var D={
 en:{
  ...
  slider_verifying:"Verifying...",slider_retry:"Please try again",slider_near:"Almost there!",
  click_wrong:"Wrong order, try again",click_verifying:"Verifying...",
  captcha_wrong:"Incorrect, please try again",captcha_verifying:"Verifying...",captcha_refreshed:"New code generated"
 },
 zh:{
  ...
  slider_verifying:"验证中...",slider_retry:"请重试",slider_near:"快到了！",
  click_wrong:"顺序错误，请重试",click_verifying:"验证中...",
  captcha_wrong:"不正确，请重试",captcha_verifying:"验证中...",captcha_refreshed:"已生成新验证码"
 }
};
